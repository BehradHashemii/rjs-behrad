    ...
    return (
        <div className={styles.container}>
            <aside className={styles.aside}>
                <button onClick={() => setTab("overview")} className={`${activeTab === "overview" ? styles.navActive : ""} ${styles.navItem}`}>نمای کلی</button>
                <button onClick={() => setTab("tickets")} className={`${activeTab === "tickets" ? styles.navActive : ""} ${styles.navItem}`}>پیام های پشتیبانی</button>
                <button onClick={() => setTab("portfolio-request")} className={`${activeTab === "portfolio-request" ? styles.navActive : ""} ${styles.navItem}`}>درخواست های پروژه</button>
                <button onClick={() => setTab("users")} className={`${activeTab === "users" ? styles.navActive : ""} ${styles.navItem}`}>مدیریت کاربران</button>
                <button onClick={() => setTab("portfolios")} className={`${activeTab === "portfolios" ? styles.navActive : ""} ${styles.navItem}`}>مدیریت نمونه کار ها</button>
                <button onClick={() => setTab("articles")} className={`${activeTab === "articles" ? styles.navActive : ""} ${styles.navItem}`}>مدیریت مقالات</button>
            </aside>
            <main className={styles.main}>
                ...
                {activeTab === "users" && (
                    <div>
                        ...
                        <UsersTab styles={styles} searchUser={searchUser} roleFilter={roleFilter} setRoleFilter={setRoleFilter} users={users} filteredUsers={filteredUsers} handleToggleRole={handleToggleRole} setUserToDelete={setUserToDelete} userToDelete={userToDelete} setIsAddUserModalOpen={setIsAddUserModalOpen} isAddUserModalOpen={isAddUserModalOpen} handleAddUserSubmit={handleAddUserSubmit} newUserForm={newUserForm} setNewUserForm={setNewUserForm} />
                    </div>
                )}
