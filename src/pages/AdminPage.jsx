...
export default function AdminPage() {
    ...
    // کنترل سایدبار و تب فعال: 'dashboard' | 'analytics' | 'users' | 'tickets' | 'projects' | 'articles'
    ...
    // اسکرول خودکار چت تیکت
    useEffect(() => {
        if (selectedTicket && adminChatEndRef.current) {
                ...
                <aside className={styles.sidebar}>
                    <div className={styles.sidebarHeader}>
                        <div className={styles.adminBrand}>
                            ...
                            {!sidebarCollapsed && <span>پنل ادمین</span>}
                        </div>
                        <button
                    ...
                    {!sidebarCollapsed && (
                        <div className={styles.adminProfileCard}>
                            ...
                            <div className={styles.profileInfo}>
                                <strong>{user?.displayName || "مدیر اصلی"}</strong>
                        ...
                        >
                            ...
                            {!sidebarCollapsed && (
                                <div className={styles.navTextWithBadge}>
                                    ...
                                    <span className={styles.badgeWarning}>{tickets.length}</span>
                                </div>
                            )}
                        </button>
                        ...
                        >
                            ...
                            {!sidebarCollapsed && (
                                <div className={styles.navTextWithBadge}>
                                    ...
                                    <span className={styles.badgeInfo}>{projects.length}</span>
                                </div>
                            )}
                        </button>
                            ...
                            <div className={styles.statsGrid}>
                                <div className={styles.statCard}>
                                    ...
                                    <div className={styles.statInfo}>
                                        ...
                                        <h3>{users.length} نفر</h3>
                                        <small className={styles.textSuccess}>
                                            {users.filter((u) => u.role === "admin").length} مدیر |{" "}
                                            {users.filter((u) => u.role !== "admin").length} کاربر عادی
                                        </small>
                                    </div>
                                </div>
                                ...
                                <div className={styles.statCard}>
                                    ...
                                    <div className={styles.statInfo}>
                                        ...
                                        <h3>{tickets.length} تیکت</h3>
                                        <small className={styles.textWarning}>
                                            {tickets.filter((t) => t.status === "پاسخ داده شده").length} پاسخ‌داده |{" "}
                                            {tickets.filter((t) => t.status !== "بسته شده").length} فعال
                                        </small>
                                    </div>
                                </div>
                                    ...
                                    <div className={styles.chatModalWindow}>
                                                ...
                                                return (
                                                    <div
                                                        ...
                                                        className={`${styles.chatBubble} ${
                                                            isAdminMsg ? styles.chatBubbleAdmin : styles.chatBubbleUser
                                                        }`}
                                                    >
                                                        <div className={styles.chatBubbleHeader}>
                                                            <strong>
                                                                {isAdminMsg
                                                                    ? msg.senderName || "پشتیبانی ادمین"
                                                                    : msg.senderName ||
                                        ...
                                        <form onSubmit={handleSendTicketReply} className={styles.chatReplyForm}>
                                            <textarea
                                                ...
                                                placeholder="پاسخ ادمین را بنویسید... (Enter برای ارسال)"
                                                value={ticketReply}
                            ...
                            <div className={styles.cardsGrid}>
                                {filteredArticles.map((art) => (
                                    <div key={art.id} className={styles.card}>
                                        ...
                                        <div className={styles.cardMeta}>
                                            <span>❤️ {art.likes} لایک | 🔖 {art.saves} ذخیره</span>
